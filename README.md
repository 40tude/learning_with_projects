...
# lbp - Learning with projects

## Description

* These are a set of 5 projects I plan to work on in order to improve my skills in Rust.
* I use Claude Code to determine the crates to study and the projects to build.
* I share the prompts I use, show the discussions etc.
...
---
## Selecting the crates and defining the projects
